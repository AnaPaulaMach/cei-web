        ...
        <XPWindow title="CEI/welcome.exe" className="window-pop">
          <div className="space-y-6">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
              <div className="grid h-20 w-20 shrink-0 place-items-center rounded-sm border border-cei-shadow/35 bg-white shadow-[3px_3px_0_rgba(15,42,95,0.22)]">
                <Image
                  alt="Logo CEI"
              ...
              <div>
                ...
                <p className="mt-2 w-fit max-w-full rounded-sm bg-cei-alert px-3 py-1 font-mono text-xs font-black uppercase text-cei-shadow shadow-[2px_2px_0_rgba(15,42,95,0.25)]">
            ...
            <div className="space-y-4">
              <h1 className="max-w-4xl font-mono text-4xl font-black leading-tight text-cei-shadow md:text-5xl">
            ...
            <div className="flex flex-wrap gap-3">
              <Button href="#tablero">Ver tablero</Button>
